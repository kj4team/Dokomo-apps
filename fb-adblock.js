(function() {
  ...
  function getBlockedList() {
    const ariaLabels = sponsoredTexts.map(t => `div[aria-label="${t}"]`);
  ...
  //   console.warn("kal transform", node);
  //   let i;
  ...
  function getVisibleText(e) {
    ...
    if (children.length !== 0) {
      ...
      if (elementComputedStyle.display === "flex") {
        ...
        //     // return style.getPropertyValue('order') !== "";
        //     // })
        //     .filter(e => window.getComputedStyle(e).top === '0px' && window.getComputedStyle(e).order > 0)
        ...
        // ;
        // var output = '';
        // for (var property in a2) {
        //   output += property + ': ' + a2[property]+'; ';
        // }
        // console.warn(output);
        ...
        /*return (
          ...
          Array.prototype.slice
            ...
            .map((e) => [parseInt(e.style.getPropertyValue('order')), getVisibleText(e)])
  ...
  const possibleSponsoredTextQueries$1 = [
